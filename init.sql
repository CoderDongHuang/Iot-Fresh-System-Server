...
('DEV001', '鲜品存储设备001', 'storage', '仓库A区', '13800138002', '主存储设备'),
('DEV002', '鲜品存储设备002', 'storage', '仓库B区', '13800138003', '备用存储设备');

-- 插入示例设备数据
INSERT INTO device_data (vid, device_type, tin, tout, lxin, battery, created_at) VALUES
('DEV001', 'storage', 22.5, 18.0, 300, 85, NOW()),
